...
from .TransformerSTmodel import TransformerSpatioTemporalModel_mambaID as TransformerSpatioTemporalModel
...
class UNetSpatioTemporalConditionModel(ModelMixin, ConfigMixin, UNet2DConditionLoadersMixin):
    ...
    def forward(
        ...
        if isinstance(encoder_hidden_states, tuple):
            ...
            encoder_hidden_states = (encoder_hidden_states, ip_hidden_states, expr_hidden_states)
...
def add_ip_adapters(unet, num_adapter_embeds=[32,], scale=[1.0,]):
    ...
    for name in unet.attn_processors.keys():
        cross_attention_dim = None if name.endswith("attn1.processor") else unet.config.cross_attention_dim #spatial attention
